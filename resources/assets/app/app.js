...
.constant('appname', 'Elude')

.constant('version', 'v0.1.0')

.constant('appdir', 'assets/app')

//apiConfig is mandatory to use "Api" service of Elude
.constant('apiConfig', {
    'url': '/api/v1', //you can set the whole URL here : e.g http://example.com/api/v1
    'token': {
        //read the auth token from the html (generated by the PHP part of Elude)
        // this is why we have to include jquery ...
        'type': $('meta[name="token_type"]').prop('content'), //this should be "Bearer" if you use Elude as a WS
